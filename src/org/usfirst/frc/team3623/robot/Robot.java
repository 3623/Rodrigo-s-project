...
public class Robot extends IterativeRobot {
	...
	Spark m_rearLeft1 = new Spark(2);
	Spark m_frontRight = new Spark(3);	
	Spark m_rearRight = new Spark(4);
	//Define joystick being used at USB port 1 on the Driver Station
	Joystick m_driveStick = new Joystick(1);
	MecanumDrive m_robotDrive = new MecanumDrive(m_frontLeft,  m_rearLeft1, m_frontRight,m_rearRight);
	...
	{
		m_robotDrive.driveCartesian(m_driveStick.getRawAxis(1),m_driveStick.getRawAxis(0),m_driveStick.getRawAxis(4));
	}
